...
import { createPurchaseBill, createSalesBill, getAllProducts, getAllVendors } from "@/app/helper/apiHelper";
...
const SalesBill = () => {
  ...
  const handleFinish = async (value) =>{
    try{
     ...
     await  createPurchaseBill(value);
     router.back();
    }catch(err){
      console.log(err)
    }
      ...
      <div className="flex px-5 min-h-[calc(100vh-100px)]">
        <div className="bg-white rounded-2xl shadow-2xl w-[100%] h-[100%] p-5 flex flex-wrap justify-start items-start">
          ...
          >
            ...
            <Form.Item
              name="customer_name"
              label={<span className="form_label">Vendor Name</span>}
